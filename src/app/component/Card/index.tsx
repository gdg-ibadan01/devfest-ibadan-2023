...
const Card: FC<cardInterface> = ({ data, title }) => {
    ...
    return (
        <>
            {title === 'speaker' && <div className={`${Styles["speaker--card"]} ${Styles.big}`} style={{ backgroundColor: color }}>
            ...
            {title === 'organizer' && <div className={`${Styles["speaker--card"]} ${Styles.medium}`} style={{ backgroundColor: '#E9ECED' }}>
